...
if __name__ == '__main__':
    ...
    def tst1():
        ...
        #cs = ['柊', '咔', '哒', '暧', '阱', '嘀', '呃', '尴', '尬', '昵', '邂', '逅', '嗯', '猥', '霾', '咦', '唔', '伫', '臊', '咚', '“', '”', '愕', '嗒', '朦', '胧', '噘', '诶', '黏', '啧', '咧', '噜', '《', '》', '唰', '攥', '扉', '嘟', '喽', '杞', '啜', '噗', '嗤', '沌', '淅', '熵', '漪', '漉', '踉', '跄', '—', '蜷', '趿', '噼', '囔', '叽', '吡', '喹', '咿', '偎', '蚰', '慵', '潺', '皙', '濡', '兮', '跤', '掬', '踝', '愣', '惘', '邃', '讪', '嬉', '癖', '啁', '啾', '沐', '拗', '忏', '衾', '嗨', '睑', '憧', '憬', '褶', '龃', '龉', '嫣', '檐', '炖', '哏', '耷', '锵', '弈', '觑', '惆', '怅', '瞌', '咻', '鸢', '町', '羁', '唳', '猝', '魅', '犷', '噔', '潢', '喃', '喵', '噢', '颚', '啰', '嗦', '噩', '懑', '咣', '唧', '簌', '祉']
        #cs = cs[49:52]
        #print(''.join(cs))
